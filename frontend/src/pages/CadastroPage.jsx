...
function CadastroPage({ onLogout }) {
  ...
  const abas = [
    ...
    { 
      id: 'lista', 
      nome: 'Todos os Cadastros', 
      icone: Users, 
      descricao: 'Visualizar lista',
      cor: 'purple'
    },
    { 
      id: 'obter', 
      nome: 'Buscar Cadastro', 
      icone: Search, 
      descricao: 'Encontrar usuário',
      cor: 'purple'
    }
  ];
          ...
          <div className="flex items-center justify-between h-16 lg:h-20">
            ...
            <div className="flex items-center gap-4">
              <button
                ...
                className="p-2 text-purple-300 hover:text-white hover:bg-white/10 rounded-xl transition-all duration-200 flex items-center gap-2 group"
              >
                <Home size={20} />
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="hidden lg:block text-sm text-purple-200">
                    Gerencie usuários e dados pessoais
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="bg-white/10 backdrop-blur-xl rounded-2xl border border-white/20 p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-purple-200">{abaAtual.descricao}</p>
              </div>
            </div>
          </div>
        </div>
